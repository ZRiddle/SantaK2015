...
Santa.save_data('_v7_4')
'''

# Destroy Small trips
tripid = 5
while Santa.trip_metrics.shape[0] > 1550:    
    stwrw = Santa.wrw
    ...
    if tripid > Santa.trip_metrics.shape[0]:
        tripid = tripid - Santa.trip_metrics.shape[0] + 5
